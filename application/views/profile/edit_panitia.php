                ...
                <div class="nav-tabs-custom">
                    ...
                    <div class="tab-content">
                        <div class="active tab-pane" id="edit_profil">
                            <div class="box-body">
                                <form method="post" enctype="multipart/form-data" action="<?= site_url('profile/edit_panitia/' . $panitia['id_panitia']) ?>" class="form-horizontal">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" class="form-control" id="handphone" name="handphone" value="<?php echo $panitia['telepon_panitia']; ?>">
                                                <?php echo form_error('handphone', '<small class="text-danger pl-3">', '</small>') ?>
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <label for="nama" class="col-sm-3 control-label">Foto</label>
                                            <div class="col-sm-6">
                                        ...
                                        <div class="box-footer">
                                            <div class="pull-left">
                                                <a href="<?php echo site_url('profile/profil_panitia'); ?>" type="submit" class="btn btn-warning"><i class="fa fa-rotate-left"></i> Kembali</a>
                                                <button type="submit" class="btn btn-primary"><i class="fa fa-pencil-square-o"></i> Edit Profile</button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
                        ...
                        <div class="tab-pane" id="change_password">
                            <div class="box-body">
                                <form method="post" action="<?= site_url('profile/change_passwordPanitia/' . $panitia['id_panitia']) ?>" class="form-horizontal">
                                    <div class="box-body">
                                        <div class="form-group">
