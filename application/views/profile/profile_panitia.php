                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <table class="table">
                            ...
                            <tr>
                                <td>Sekolah</td>
                                <td>: <?php echo $panitia['nama_sekolah']; ?></td>
                            </tr>
                            <tr>
                                <td>Jabatan</td>
                        ...
                        <div class="box-footer">
                            <div class="pull-left">
                                <a href="<?php echo site_url('profile/edit_panitia'); ?>" type="submit" class="btn btn-primary"><i class="fa fa-pencil-square-o"></i> Edit Profile</a>
                            </div>
                        </div>
                    </div>
                </div>
