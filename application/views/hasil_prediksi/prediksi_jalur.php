<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            HASIL PREDIKSI JALUR PENDAFTARAN
        </h1>
    </section>
        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box box-primary">
                    ...
                    <!-- /.box-header -->
                    <div class="box-body">
                        <form action="<?php echo site_url('hasil_prediksi/prediksi_jalur'); ?>" method="post" class="form-horizontal">
        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box box-primary">
                            ...
                            <table id="example2" class="table table-bordered table-striped table-hover text-center">
                                <thead>
                                    <tr class="text-center">
                                        ...
                                        <th colspan="<?=$jalur_pendaftaran->num_rows()?>">Kecamatan</th>
                                        <th rowspan="2">Total</th>
                                    </tr>
                                    <tr class="text-center">
                                      <?php if($jalur_pendaftaran->num_rows() > 0 ){
                                         foreach($jalur_pendaftaran->result() as $key => $value) { ?>
                                        <th><?php echo $value->nama_jalur ?></th>
                                      <?php } } ?>
                                    </tr>
                                </thead>
                                <tbody>
                                  ...
                                  foreach ($tahun_akademik as $key => $value) { ?>
                                    <tr class="text-center">
                                      ...
                                      $total_qty = 0;
                                      $total_qty_t = 0;
                                      foreach($jalur_pendaftaran->result() as $key => $kec) {
                                      $dist = $this->db->query("SELECT COUNT(no_form) as qty FROM `jalur_pendaftaran` LEFT JOIN `ppdb` ON `ppdb`.`id_jalur` = `jalur_pendaftaran`.`id_jalur` WHERE tahun_akademik = '$value->tahun_akademik' AND jalur_pendaftaran.id_jalur = '$kec->id_jalur'");
                                ...
                                <tfoot>
                                  ...
                                  $total_qty_ta = 0;
                                  foreach($jalur_pendaftaran->result() as $key => $kec) {
                                  $dist = $this->db->query("SELECT COUNT(no_form) as qty FROM `jalur_pendaftaran` LEFT JOIN `ppdb` ON `ppdb`.`id_jalur` = `jalur_pendaftaran`.`id_jalur` WHERE jalur_pendaftaran.id_jalur = '$kec->id_jalur'");
                                  foreach ($dist->result() as $key => $dis) {
                    ...
                    <div class="box box-primary">
                      <div class="box-header">
                        <h2>Jalur Pendaftaran <?php echo $kec->nama_jalur; ?></h2>
                      </div>
                      <div class="box-body">
                          <div class="table-responsive">
                              <table id="example<?=$kec->id_jalur;?>" class="table table-bordered table-striped table-hover text-center">
                                <thead>
                                  <tr>
                                ...
                                <tbody>
                                  ...
                                  foreach ($tahun_akademik as $key => $value) {
                                    ...
                                    $dist = $this->db->query("SELECT count(no_form) as qty FROM jalur_pendaftaran LEFT JOIN ppdb ON ppdb.id_jalur = jalur_pendaftaran.id_jalur WHERE tahun_akademik = '$value->tahun_akademik' AND ppdb.id_jalur = '$kec->id_jalur'");
                                    $jumlah_x += $x;
                    ...
                    <div class="box box-primary">
                      <div class="box-header">
                        <h2>Mape Jalur Pendaftaran <?=$kec->nama_jalur;?></h2>
                      </div>
                      <div class="box-body">
                          <div class="table-responsive">
                              <table id="example<?=$kec->id_jalur;?>" class="table table-bordered table-striped table-hover text-center">
                                ...
                                <tfoot>
                                  <tr>
                                    <th colspan="5">MAPE <?=$kec->nama_jalur;?></th>
